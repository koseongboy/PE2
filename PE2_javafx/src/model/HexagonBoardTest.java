...
public class HexagonBoardTest {
    ...
    @Test
    @DisplayName("각 노드에 말이 없을 때 맵 데이터에 말이 올라가 있지 않다고 뜨는 지")
    ...
    @Test
    @DisplayName("노드에 말이 하나 올라갔을 때 제대로 표시되는 지")
    ...
    @Test
    @DisplayName("노드에 말이 여러 개 올라갔을 때 제대로 표시되는 지")
    ...
    @Test
    @DisplayName("처음 던졌을 때 백도가 나온 경우")
    ...
    @Test
    @DisplayName("처음 던진 백도가 다른 말을 잡았을 경우")
    ...
    @Test
    @DisplayName("처음 던진 백도가 다른 말에 업혔을 경우")
    ...
    @Test
    @DisplayName("처음 굴렸을 때 백도를 제외한 다른 말이 나오고 도착지에 아무 말도 없을 경우")
    ...
    @Test
    @DisplayName("처음 굴렸을 때 백도를 제외한 다른 말이 나오고 도착지에 같은 플레이어의 말이 있을 경우")
    ...
    @Test
    @DisplayName("처음 굴렸을 때 백도를 제외한 다른 말이 나오고 도착지에 상대편 플레이어의 말이 있을 경우")
    ...
    @Test
    @DisplayName("처음 백도가 나온 후 백도가 한 번 더 나온 경우")
    ...
    @Test
    @DisplayName("기존 보드에 올라간 말을 백도로 이동시켰을 때 도착지에 아무런 말이 없는 경우")
    ...
    @Test
    @DisplayName("기존 보드에 올라간 말을 백도로 이동시켰을 때 도착지에 상대편 말이 있는 경우")
    ...
    @Test
    @DisplayName("기존 보드에 올라간 말을 백도로 이동시켰을 때 도착지에 같은 플레이어의 말이 있는 경우")
    ...
    @Test
    @DisplayName("기존 보드에 올라간 말을 백도가 아닌 다른 윷 결과로 이동시켰을 때 도착지에 아무런 말이 없는 경우")
    ...
    @Test
    @DisplayName("기존 보드 꼭지점에 올라간 말을 백도가 아닌 다른 윷 결과로 이동시킨 경우")
    ...
    @Test
    @DisplayName("기존 보드 중앙에 올라간 말을 백도가 아닌 다른 윷 결과로 이동시킨 경우")
    ...
    @Test
    @DisplayName("기존 보드에 올라간 말을 백도가 아닌 윷 결과로 이동시켰을 때 도착지에 상대편 말이 있는 경우")
    ...
    @Test
    @DisplayName("기존 보드에 올라간 말을 백도가 아닌 윷 결과로 이동시켰을 때 도착지에 같은 플레이어의 말이 있는 경우, 그룹화 후 이동이 잘 되는 지")
    ...
    public void test_center_backdo() {
        ...
        assertFalse(result);
        assertEquals(board.getNode(34), p1.getPosition());
        assertEquals(Piece.State.ON_BOARD, p1.getStatus());
        ...
        assertFalse(result);
        assertEquals(board.getNode(36), p2.getPosition());
        assertEquals(Piece.State.ON_BOARD, p2.getStatus());
        ...
        assertFalse(result);
        assertEquals(board.getNode(38), p3.getPosition());
        ...
        assertFalse(result);
        assertEquals(board.getNode(40), p4.getPosition());
        assertEquals(Piece.State.ON_BOARD, p4.getStatus());
    ...
    public void test_vertical_backdo_1() {
        ...
        assertFalse(result);
        assertEquals(board.getNode(24), p1.getPosition());
        assertEquals(Piece.State.ON_BOARD, p1.getStatus());
    ...
    public void test_vertical_backdo_2() {
        ...
        assertFalse(result);
        assertEquals(board.getNode(30), p1.getPosition());
        assertEquals(Piece.State.ON_BOARD, p1.getStatus());
        ...
        assertFalse(result);
        assertEquals(board.getNode(29), p2.getPosition());
        assertEquals(Piece.State.ON_BOARD, p2.getStatus());
