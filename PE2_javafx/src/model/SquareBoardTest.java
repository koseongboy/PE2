...
public class SquareBoardTest {
    ...
    public void test_roll_forward_vertical() {
        ...
        assertFalse(result);
        assertEquals(board.getNode(23), p1.getPosition());
        assertEquals(Piece.State.ON_BOARD, p1.getStatus());
    }
    ...
    public void test_roll_forward_center() {
        ...
        assertFalse(result);
        assertEquals(board.getNode(21), p1.getPosition());
        assertEquals(Piece.State.ON_BOARD, p1.getStatus());
        ...
        assertEquals(board.getNode(27), p2.getPosition());
        assertEquals(Piece.State.ON_BOARD, p2.getStatus());
    }
    ...
    public void test_center_backdo() {
        ...
        assertFalse(result);
        assertEquals(board.getNode(26), p2.getPosition());
        assertEquals(Piece.State.ON_BOARD, p2.getStatus());
    ...
    public void test_vertical_backdo_1() {
        ...
        assertFalse(result);
        assertEquals(board.getNode(14), p1.getPosition());
        assertEquals(Piece.State.ON_BOARD, p1.getStatus());
    ...
    public void test_vertical_backdo_2() {
        ...
        assertFalse(result);
        assertEquals(board.getNode(20), p1.getPosition());
        assertEquals(Piece.State.ON_BOARD, p1.getStatus());
        ...
        assertFalse(result);
        assertEquals(board.getNode(19), p2.getPosition());
        assertEquals(Piece.State.ON_BOARD, p2.getStatus());
